...
public class CardPresenter extends Presenter {
	...
	public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object o) {
		...
		((ViewHolder) viewHolder).mCardView.setContentText(image.getArtist());
		((ViewHolder) viewHolder).mCardView.setMainImageDimensions(CARD_WIDTH * 2 , CARD_HEIGHT * 2);
		((ViewHolder) viewHolder).updateCardViewImage(image.getDisplayByType(Image.DisplaySizeType.THUMB).getUri());
	}
